...
object PolymorphicFunctions {
  ...
  isSorted(Array(3,2,1), gt)
  isSorted(Array(1,2,3), gt)
  def bigInterval(a: Int, b: Int): Boolean = a - 5 > b
  isSorted(Array(3,2,1), bigInterval)
  isSorted(Array(30,20,1), bigInterval)
